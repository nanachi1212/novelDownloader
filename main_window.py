...
class NovelDownloaderUI(QMainWindow):
    def __init__(self):
        ...
        advanced_layout.addWidget(self.site_settings_btn)
        ...
        advanced_layout.addWidget(self.cookies_btn)
        advanced_layout.addWidget(QLabel("重試:"))
        ...
        advanced_layout.addWidget(self.output_format_input)
        advanced_layout.addWidget(QLabel("檔名:"))
        ...
        tools_layout.addWidget(self.cache_btn)
